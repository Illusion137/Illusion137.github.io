...
export const projects: Project[] = [
	...
	},
	{
		...
		skills: ['typescript'],
		showcase: [
			{ src: 'showcase/ytjs-0.png', alt: 'YouTube.js screenshot 1' },
		],
		github_url: 'https://github.com/LuanRT/YouTube.js/pulls?q=is%3Apr+author%3AIllusion137+',
	},
	{
		id: 'musi',
		title: 'Musi (https://feelthemusi.com/)',
		role_title: 'Contributor',
		...
		cover: { src: 'covers/musi.png', alt: 'Musi cover' },
		skills: ['javascript'],
		showcase: [
			{ src: 'showcase/musi-0.png', alt: 'Musi screenshot 1' },
		],
	},
	{
		id: 'vlc-portfolio',
